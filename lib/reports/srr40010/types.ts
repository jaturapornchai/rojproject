// Types สำหรับ SRR40010 - รายงานเปรียบเทียบราคาขาย
...
export type DiffFilterType = '0' | '1' | '2' | '3'; // 0: !=0, 1: >0, 2: <0, 3: All
export type SaleType = 'all' | 'backend' | 'pos';

export interface ReportFilters {
    customer: CustomerFilterState;
    branch: BranchFilterState;
    diffFilter: DiffFilterType;
    saleType: SaleType;
}
...
export interface EmailSchedule {
    ...
    filter_config?: ReportFilters; // เพิ่มสำหรับเก็บ filter settings
    created_at?: string;
    updated_at?: string;
}
