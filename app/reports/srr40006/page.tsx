...
import { useReportFilters, useDateRange, useMasterData } from '@/hooks/reports/srr40006';
import {
    FilterPanel,
    DatePresetButtons,
    MonthYearSelector
} from '@/components/reports/srr40006';
...
export default function ReportSRR40006() {
        ...
        <main className="min-h-screen bg-slate-50">
            ...
            <div className="bg-white shadow-sm border-b border-slate-200 sticky top-0 z-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                    ...
                    <Link
                        href="/reports/srr40006/schedules"
