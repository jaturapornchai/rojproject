...
import { useReportFilters, useDateRange, useMasterData } from '@/hooks/reports/srr20016';
import {
    FilterPanel,
    DatePresetButtons,
    MonthYearSelector
} from '@/components/reports/srr20016';
...
export default function ReportSRR20016() {
    ...
    // ใช้ Custom Hooks
    const { startDate, endDate, setStartDate, setEndDate, handlePreset, handleMonthSelect, handleYearSelect } = useDateRange({ defaultPreset: 'this_month' });
    ...
    const handleGenerateResult = async () => {
        ...
        try {
            ...
            console.log('GUID from generate-report:', reportData.guid);
            ...
            if (reportData.guid) {
                console.log('Calling generatePDF with GUID:', reportData.guid);
    ...
    const generatePDF = async (guid: string) => {
        try {
            ...
            console.log('PDF Config:', JSON.stringify(pdfConfig, null, 2));
            ...
            if (!pdfRes.ok) {
                ...
                if (contentType && contentType.includes('application/json')) {
                    ...
                    throw new Error(errorData?.error || errorData?.message || 'ไม่สามารถสร้าง PDF ได้');
                } else {
                    const errorText = await pdfRes.text();
                    console.error('PDF API Error Text:', errorText);
                    ...
                    <div className="bg-white rounded-xl shadow-lg border border-slate-200 overflow-hidden h-[800px] animate-in fade-in slide-in-from-bottom-4">
                        <div className="px-6 py-4 border-b border-slate-200 bg-slate-50 flex items-center justify-between">
                            ...
                            <a
                                ...
                                className="px-3 py-1.5 text-sm bg-rose-600 text-white rounded-lg hover:bg-rose-700 transition"
                            >
                                ดาวน์โหลด PDF
                            </a>
                        </div>
