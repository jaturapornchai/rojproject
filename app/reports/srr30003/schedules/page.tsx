...
import { useReportFilters, useMasterData } from '@/hooks/reports/srr30003';
import { FilterPanel, FilterSummary } from '@/components/reports/srr30003';
...
export default function ScheduleManagement() {
    ...
    const [formData, setFormData] = useState({
        ...
        email_subject: 'รายงานเปรียบเทียบต้นทุนการซื้อล่าสุด',
        include_pdf: true,
    });
            ...
            <div className="bg-white shadow-sm border-b border-slate-200 sticky top-0 z-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <Link href="/reports/srr30003" className="text-slate-400 hover:text-emerald-600 transition-colors">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="border-t border-slate-200 pt-6">
                                ...
                                >
                                    ...
                                    🔍 ตัวกรองรายงาน (เอกสาร/สินค้า/กลุ่มสินค้า/ยี่ห้อสินค้า/คลัง/ชั้นวาง)
                                </button>
