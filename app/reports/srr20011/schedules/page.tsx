...
import {
    ...
    deserializeFilters,
    type EmailSchedule
} from '@/lib/reports/srr20011';
import { useReportFilters, useMasterData } from '@/hooks/reports/srr20011';
import { FilterPanel, FilterSummary } from '@/components/reports/srr20011';
...
export default function ScheduleManagement() {
    ...
    const [formData, setFormData] = useState({
        ...
        email_subject: 'รายงานสินค้าใหม่ แสดงระดับราคา',
        include_pdf: true,
    });
                    ...
                    <div className="bg-white rounded-xl shadow-xl max-w-md w-full p-6 space-y-4 animate-in zoom-in-95 duration-200">
                        ...
                        <div className="flex justify-end gap-3 pt-2">
                            ...
                            <button
                                ...
                                className="px-4 py-2 text-white bg-emerald-600 hover:bg-emerald-700 rounded-lg font-medium transition-colors shadow-sm shadow-emerald-200"
                            >
                                ยืนยันส่งทันที
                            </button>
                        </div>
            ...
            <div className="bg-white shadow-sm border-b border-slate-200 sticky top-0 z-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <Link href="/reports/srr20011" className="text-slate-400 hover:text-emerald-600 transition-colors">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="border-t border-slate-200 pt-6">
                                ...
                                >
                                    ...
                                    🔍 ตัวกรองรายงาน (เงื่อนไขสินค้า/กลุ่มสินค้า/ยี่ห้อสินค้า)
                                </button>
                                    ...
                                    <div className="flex items-start justify-between">
                                        ...
                                        <div className="flex gap-2 ml-4">
                                            <button
                                                ...
                                                className="px-3 py-1.5 text-sm bg-emerald-600 text-white rounded-lg hover:bg-emerald-700 transition disabled:bg-slate-300 disabled:cursor-not-allowed"
                                            >
