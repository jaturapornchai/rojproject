...
import {
    ...
    MonthYearSelector,
    FilterSummary
} from '@/components/reports/srr20011';
...
export default function ReportSRR20011() {
        ...
        <main className="min-h-screen bg-slate-50">
            ...
            <div className="bg-white shadow-sm border-b border-slate-200 sticky top-0 z-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
                    ...
                    <Link
                        href="/reports/srr20011/schedules"
                ...
                {pdfUrl && (
                    <div className="bg-white rounded-xl shadow-lg border border-slate-200 overflow-hidden h-[800px] animate-in fade-in slide-in-from-bottom-4">
                        <div className="px-6 py-4 border-b border-slate-200 bg-slate-50 flex items-center justify-between">
                            ...
                            <a
                                href={pdfUrl}
                                download="รายงานสินค้าใหม่-แสดงระดับราคา.pdf"
