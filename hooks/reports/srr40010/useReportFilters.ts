// Custom Hook สำหรับจัดการ Filter State - SRR40010
...
} from '@/lib/reports/srr40010/config';
...
export interface UseReportFiltersReturn {
    ...
    // Other Filters
    setDiffFilter: (filter: DiffFilterType) => void;
...
export function useReportFilters(initialFilters?: Partial<ReportFilters>): UseReportFiltersReturn {
    ...
    const setDiffFilter = useCallback((filter: DiffFilterType) => {
        setFiltersState(prev => ({
            ...prev,
            diffFilter: filter
        }));
